...
product_name = 'Derpi'
description = 'Derpi Server'
long_desc = '''Derpi is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.derpi.ir'
author = 'OpenERP S.A.'
author_email = 'info@derpi.ir'
license = 'LGPL-3'

nt_service_name = "derpi-server-" + series.replace('~','-')
